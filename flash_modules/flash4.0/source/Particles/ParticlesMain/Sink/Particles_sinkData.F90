!!****if* source/Particles/ParticlesMain/Sink/Particles_sinkData
!!
!! NAME
!!
!!    Particles_sinkData
...
#include "Flash.h"
  ...
  logical, save :: sink_stop_on_creation
  real,    save :: sink_stop_on_total_mass
  ...
  real, save :: newton, accretion_radius, softening_radius, sink_density_thresh_factor

  integer, save :: softening_type_gas, softening_type_sinks, integrator, sink_grav_boundary_type
