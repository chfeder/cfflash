!!****if* source/Particles/ParticlesMain/Sink/Particles_sinkAdvanceParticles
!!
!! NAME
!!
...
subroutine Particles_sinkAdvanceParticles(dr_dt)
  ...
  use pt_sinkInterface, ONLY: pt_sinkAccelSinksOnSinks, pt_sinkGetSubCycleTimeStep, pt_sinkGatherGlobal
...
#include "Particles.h"
  ...
  integer, parameter :: gather_nprops = 14
  integer, dimension(gather_nprops), save :: gather_propinds = &
    (/ integer :: ACCX_PART_PROP, ACCY_PART_PROP, ACCZ_PART_PROP, &
                  ...
                  DTOLD_PART_PROP, MASS_PART_PROP /)
