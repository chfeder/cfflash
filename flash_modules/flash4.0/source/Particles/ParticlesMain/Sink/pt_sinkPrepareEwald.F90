!!****if* source/Particles/ParticlesMain/Sink/pt_sinkPrepareEwald
!!
!! NAME
!!
!!  pt_sinkPrepareEwald
...
#include "constants.h"
  ...
  logical :: file_exists
  character(len=MAX_STRING_LENGTH) :: strbuff, openflag
...
! ============================================
  ...
  if (sink_grav_boundary_type .ne. 2) return
