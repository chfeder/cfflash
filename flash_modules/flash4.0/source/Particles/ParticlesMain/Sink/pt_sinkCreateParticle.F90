!!****if* source/Particles/ParticlesMain/Sink/pt_sinkCreateParticle
!!
!! NAME
!!
...
#define get_ppe(arg1) ((arg1) - get_pno(arg1)*65536)
  ...
  integer             :: pt_sinkCreateParticle, pno, tag
  ...
  particles_local(:, pno) = 0.0 ! set everything to 0.0 to begin with
  ...
  particles_local(TYPE_PART_PROP,pno) = pt_typeInfo(PART_TYPE,SINK_PART_TYPE)
#endif
