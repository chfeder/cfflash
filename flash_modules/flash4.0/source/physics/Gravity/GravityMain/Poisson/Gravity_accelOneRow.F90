...
#include "constants.h"
  ...
  real    :: blockSize(MDIM), gpot(numCells), delxinv
  ...
  ! If a variable index is explicitly specified, use that as the potential;
  ...
  !----------------------------------------------------------------------------------
  ! Compute gravitational acceleration; first-order differences preserve conservation
  !----------------------------------------------------------------------------------
